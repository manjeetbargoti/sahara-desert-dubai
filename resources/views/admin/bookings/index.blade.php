    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-between">
                ...
                <div class="nk-block-head-content">
                    <a href="{{ route('admin.bookings.export', request()->input()) }}" class="btn btn-dim btn-outline-info"><em class="icon ni ni-download"></em><span>Export Bookings</span></a>
        ...
        <div class="card card-bordered card-preview">
            <div class="card-header">
                <form class="booking-search" id="bookingSearch" method="get" action="{{ route('admin.bookings.list') }}">
                    {{-- @csrf --}}
                    <div class="row">
                        <div class="col-sm-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        <ul class="link-list-plain">
                                            ...
                                            <li><a href="{{ route('admin.bookings.invoice.download', @$booking->id) }}" class="text-success">{{ __('Invoice') }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
