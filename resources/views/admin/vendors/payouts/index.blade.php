...
<div class="col-xl-12">
    <div class="row g-4">
        ...
        <div class="col-sm-3 col-xs-12 m-auto">
            <a href="{{ route('admin.vendor.payout.add_tranx', @$vendorUser->id) }}">
                <div class="nk-order-ovwg-data buy bg-white">
                    <div class="title text-center"><em class="icon ni ni-plus mr-0 text-muted"></em></div>
                    <div class="pt-1 text-center">
                        <span class="text-info font-weight-bold" style="font-size: 1.2rem;">Add New Tranx</span>
                    </div>
                </div>
            </a>
        </div>
                ...
                @foreach($adminPayoutTranx as $key => $tranx)
                    <div class="nk-tb-item">
                        ...
                        <div class="nk-tb-col tb-col-sm">
                            ...
                            <span class="tb-sub">{{ date('d M, Y', strtotime($tranx->payment_date)) }}</span>
                            @endif
                        </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                    <ul class="link-list-plain">
                                        <li><a href="{{ route('admin.vendor.payout.view', $tranx->id) }}">View</a></li>
                                        <li><a href="{{ route('admin.vendor.payout.update_status', $tranx->id) }}">Update Status</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
