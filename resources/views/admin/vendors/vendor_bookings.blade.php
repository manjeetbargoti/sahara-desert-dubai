                ...
                <table class="table table-tranx">
                    ...
                    <tbody>
                        @if ($bookings->count() > 0)
                            @foreach ($bookings as $key => $booking)
                                <tr class="tb-tnx-item">
                                    ...
                                    <td>
                                        @if (@$booking->status == 1)
                                            <span class="badge badge-dim badge-outline-success">{{ __('Fulfilled') }}</span>
                                        @else
                                            <span class="badge badge-dim badge-outline-warning">{{ __('Unfulfilled') }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <span
                        ...
                        @else
                                <tr class="tb-tnx-item">
                                    <td colspan="9">
                                        <p class="text-center font-weight-bold text-muted"><em class="icon ni ni-cross-circle-fill text-danger"></em> No Booking found!</p>
                                    </td>
                                </tr>
                        @endif
                    </tbody>
