    ...
    <div class="nk-block">
        <div class="card card-bordered">
            <div class="card-inner">
                <h4 class="title text-soft mb-4 overline-title">Notification - Booking Confirmation Email for Admin</h4>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="px-3 px-sm-5 pt-3 pt-sm-5 pb-3">
                                            <h2 class="email-heading text-success">Congratulations! You received a Booking.</h2>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-3 px-sm-5 pb-2">
                                            <p>Hi {{ @$name }},</p>
                                            <p>Welcome! <br> You are receiving this email because you receive
                                                booking.</p>
                                            <p>Booking reference is <span
