        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-news">
                <div class="nk-news-list">
                    <a class="nk-news-item" target="_blank" href="{{ route('home') }}">
                    ...
                    <li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-md-block">
                                    <div class="user-status">{{ __('Vendor') }}</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{ route('vendor.settings.profile.edit') }}"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                ...
                                <ul class="link-list">
                                    <li>
                                        ...
                                        <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                this.closest('form').submit();"><em class="icon ni ni-signout"></em><span>{{ __('Sign out') }}</span></a>
                                        </form>
                                    </li>
                                </ul>
                            </div>
